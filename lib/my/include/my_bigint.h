...
bool my_bigint_set_str(
    struct my_bigint *num, const char *str) MY_ATTR_WARN_UNUSED_RESULT;
...
bool my_bigint_dprint(
    int fd, const struct my_bigint *num) MY_ATTR_WARN_UNUSED_RESULT;
