    ...
    bool endptr_unchanged)
{
    ...
    long our_result = my_strtoul(num, &end_num_ptr_us, base);
    int our_errno = errno;

    errno = -213908;

    long libc_result = strtoul(num, &end_num_ptr_libc, base);
...
Test(my_strtoul, opensolaris_invalid_base)
{
...
Test(my_strtoul, opensolaris_basic)
{
    do_one_test("0", 2);
    do_one_test("1", 36);
    do_one_test("0x20", 16);
