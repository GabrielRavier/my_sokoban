...
bool my_putnbr_base_width(
    int number, const char *base, size_t width) MY_ATTR_WARN_UNUSED_RESULT;
char *my_nbr_to_string(int number) MY_ATTR_WARN_UNUSED_RESULT;
char *my_nbr_to_string_base(
    int number, const char *base) MY_ATTR_WARN_UNUSED_RESULT;
char *my_nbr_to_string_base_width(
    int number, const char *base, size_t width) MY_ATTR_WARN_UNUSED_RESULT;
...
int my_getnbr_base(
    const char *string, const char *base) MY_ATTR_WARN_UNUSED_RESULT;
...
char *my_strstr(
    const char *haystack, const char *needle) MY_ATTR_WARN_UNUSED_RESULT;
int my_strcmp(
    const char *string1, const char *string2) MY_ATTR_WARN_UNUSED_RESULT;
...
bool my_checked_multiply(
    int lhs, int rhs, int *result) MY_ATTR_WARN_UNUSED_RESULT;
size_t my_strspn(
    const char *str, const char *accept) MY_ATTR_WARN_UNUSED_RESULT;
size_t my_strcspn(
    const char *str, const char *reject) MY_ATTR_WARN_UNUSED_RESULT;
...
void *my_memchr(
    const void *ptr, int character, size_t length) MY_ATTR_WARN_UNUSED_RESULT;
