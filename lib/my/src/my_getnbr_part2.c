...
// Checks whether there is a valid digit at *digit_ptr and gets it into digit_ptr, with the base being the contents of base. The return value determines whether this function was successful at finding a digit
