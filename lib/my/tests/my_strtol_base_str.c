...
void test_strtol(const char *string, const char *base, long expected_result, ssize_t length)
{
    char *end_pointer;
...
void test_strtol_base10(const char *string, long expected_result, size_t length)
{
